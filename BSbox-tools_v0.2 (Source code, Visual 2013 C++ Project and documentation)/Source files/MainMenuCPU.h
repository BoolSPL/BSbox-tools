...
void menuCPU(){
	do {
		...
		case 11:
			...
			cout << "\n BSbox-tools\n\n";
			cout << " Copyright @2019 Dusan and Iliya.  All rights reserved.\n\n";
		...
		case 12:
			...
			cout << " Input in file 'exampl_bool' (for Boolean funtion). \n";
			...
			cout << " Input in file 'exampl_Sbox' (for Vector Boolean function).\n";
