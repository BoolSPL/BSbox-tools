...
void CPU_boolMenu(void) {
	...
	cout << "  1. Compute Walsh spectar of Boolean function: W_f \n";
	cout << "  2. Linearity: Lin(f) \n";
	cout << "  3. Compute Walsh spectra and Linearity: W_f, Lin(f) \n";
	cout << "  4. Nonlinearity: nl(f): \n";
	cout << "  5. Autocorrelation Spectra: r_f \n";
	cout << "  6. Autocorrelation: AC(f) \n";
	cout << "  7. Compute Autocorrelation spectar and Autocorrelation: r_f, AC(f) \n";
...
void CPU_bool(void) {
	...
	do {
		...
		case 1:
			...
			//0 - menuChoice for compute Walsh spectar
		...
		case 3:
			...
			//2 - menuChoice for compute Walsh spectar and Lin
		...
		case 5:
			...
			//0 - menuChoice for compute Autocorrelation Spectra
		...
		case 7:
			...
			//2 - menuChoice for compute Autocorrelation spectar and AC
