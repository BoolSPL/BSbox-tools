...
//================================================================================
unsigned long long int binToDec(int *Bin_Vec, int size)
{
	unsigned long long int decimal = 0, counterBin = 0, bin, sum = 0;
...
//================= Generate mask for bitwise computation ==================================
void genMask(int mask_vect[], int j, int size)
{
	for (int i = 0; i<size; i++)
	{
		if ((i&j) == j)
	...
	//mack_vec_Int[counter]=binToDec(mask_vect, size);		
}
//===========================================================================
void genMaskFunc(int *mask_vec, int NumOfBits, unsigned long long int *mack_vec_Int)
{
	int counter = 0;
	for (int i = 1; i<NumOfBits; i *= 2)
	{
		genMask(mask_vec, i, NumOfBits);
		...
		mack_vec_Int[counter] = binToDec(mask_vec, NumOfBits);
		cout << " " << mack_vec_Int[counter] << "\n";
		counter++;
	}
}
//============================================================================
